    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm">
      <div className="container mx-auto px-4 h-14 md:h-16 flex items-center gap-3 md:gap-4">
        ...
        <div className="md:hidden flex items-center shrink-0 ml-auto gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-1.5 text-sm font-semibold text-gray-800 bg-gray-100 rounded-full px-3 py-2 hover:bg-gray-200 transition-colors outline-none min-h-[44px] min-w-[44px]">
                <MapPin className="w-4 h-4 text-[#EF4444] shrink-0" />
                <span className="truncate max-w-[80px]">{detecting ? "Detectando…" : (district || "Elegir")}</span>
